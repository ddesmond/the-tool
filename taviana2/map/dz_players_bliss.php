...
SELECT survivor.unique_id AS uid, survivor.worldspace, survivor.is_dead AS death, survivor.last_updated AS lastupdate, survivor.medical, survivor.inventory, survivor.backpack, survivor.model, survivor.state, profile.humanity, profile.name
FROM survivor, profile
WHERE survivor.unique_id = profile.unique_id
ORDER BY survivor.last_updated DESC, survivor.is_dead ASC
LIMIT $db_pull_limit
