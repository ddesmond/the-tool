...
function getTopLeft(world,pos,otype,id){
  ...
  if (world == 'Panthera'){
		...
		x = parseInt(Math.round(x/10))*1.849;
		y = parseInt(Math.round(y/10))*1.849;
		...
		if ((x+100)<0){
			...
			return 'top:'+(1564-y)+'px;left:'+(x+3)+'px;';
		}
	} 
  // panthera end
  ...
  // namalsk
	if (world == 'Namalsk'){
		...
		x = parseInt(Math.round(x/10))*1.416;
		y = parseInt(Math.round(y/10))*1.416;
		...
		if ((x+100)<0){
			...
			return 'top:'+(1965-y)+'px;left:'+(x+17)+'px;';
		}
	}
  // namalsk end      
  ...
  // celle
  	if (world == 'Celle'){
		...
		x = parseInt(Math.round(x/10))*0.962;
		y = parseInt(Math.round(y/10))*0.962;
		...
		if ((x+100)<0){
			...
			return 'top:'+(1460-y)+'px;left:'+(x+132)+'px;';
		}
	} 
  // celle end
    ...
    // Taviana
  	if (world == 'Taviana'){
		...
		x = parseInt(Math.round(x/10))*0.968;
		y = parseInt(Math.round(y/10))*0.968;
		...
		if ((x+100)<0){
			...
			return 'top:'+(2200-y)+'px;left:'+(x+100)+'px;';
		}
	} 
  // Taviana end
